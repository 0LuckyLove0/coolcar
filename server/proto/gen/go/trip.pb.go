...
type Trip struct {
	...
	Start         string      `protobuf:"bytes,1,opt,name=start,proto3" json:"start,omitempty"` //1是第一个字段
	...
	End           string      `protobuf:"bytes,2,opt,name=end,proto3" json:"end,omitempty"` //第二个字段
